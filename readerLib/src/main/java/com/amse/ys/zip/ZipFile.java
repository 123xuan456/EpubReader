...
public final class ZipFile {
    ...
    public LocalFileHeader getHeader(String entryName) throws IOException {
        ...
        try {
            ...
            if (header != null) {
//                // 包含图片压缩前及压缩后的大小
//                LogUtils.i21(header.FileName + ""); // OPS/images/Copyright.jpg
//                LogUtils.i21(header.NameLength + ""); // 24
//                LogUtils.i21(header.ExtraLength + ""); // 0
//                LogUtils.i21(header.CRC32 + ""); // 1197082208
//                LogUtils.i21(header.ModificationDate + ""); // 16154
//                LogUtils.i21(header.CompressedSize + ""); // 22080
//                LogUtils.i21(header.UncompressedSize + ""); // 38206
//                LogUtils.i21(header.DataOffset + ""); // 910909
                return header;
            }
        } finally {
            storeBaseStream(baseStream);
