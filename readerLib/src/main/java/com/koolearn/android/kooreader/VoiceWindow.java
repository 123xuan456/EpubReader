...
public class VoiceWindow extends LinearLayout {
    ...
    public VoiceWindow(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            initAnimator();
        }
    ...
    public VoiceWindow(Context context, AttributeSet attrs, int defStyleAttr) {
